...
// Config
set('repository','git@gitlab.junglesafariindia.in:abhishek.sinha/junglesafari_india_v2.git');
...
// Host configuration
host('production')
    ->set('hostname', '52.66.149.140')
    ->set('remote_user', 'wedding')
    ->set('deploy_path', '/var/www/html/junglesafari')
